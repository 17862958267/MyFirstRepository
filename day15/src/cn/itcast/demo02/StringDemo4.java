...
public class StringDemo4 {
	...
	/*
	 * boolean endsWith(String prefix) 判断一个字符串是不是另一个字符串的后缀,结尾 Demo.java .java
	 */
	...
	/*
	 * boolean startsWith(String prefix) 判断一个字符串是不是另一个字符串的前缀,开头 howareyou hOw
	 */
	...
	/*
	 * String substring(int beginIndex,int endIndex) 获取字符串的一部分 返回新的字符串 包含头,不包含尾巴
	 * 
	 * String substring(int beginIndex)获取字符串的一部分 包含头,后面的字符全要
	 */
